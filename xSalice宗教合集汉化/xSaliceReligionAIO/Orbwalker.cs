...
namespace xSaliceReligionAIO
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange", "普攻范围").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange_Enemy", "敌人普攻范围").SetValue(new Circle(true, Color.Pink)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Holdzone", "控制区域").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar", "小兵生命").SetValue(new Circle(true, Color.Black)));
            ...
            menuMisc.AddItem(new MenuItem("orb_Misc_ExtraWindUp", "额外停止时间").SetValue(new Slider(80, 200, 0)));
            menuMisc.AddItem(new MenuItem("orb_Misc_AutoWindUp", "自动设置停止时间").SetValue(new KeyBind("O".ToCharArray()[0], KeyBindType.Press)));
            menuMisc.AddItem(new MenuItem("orb_Misc_Priority_Unit", "优先目标").SetValue(new StringList(new[] { "Minion", "Hero" })));
            ...
            var menuModes = new Menu("走砍模式", "orb_Modes");
            {
                ...
                var modeHarass = new Menu("消耗", "orb_Modes_Harass");
