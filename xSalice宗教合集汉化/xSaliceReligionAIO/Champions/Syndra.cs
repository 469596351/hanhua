    ...
    class Syndra : Champion
    {
        ...
        private void LoadMenu()
        {
            var key = new Menu("按键", "Key");
            {
                ...
                key.AddItem(new MenuItem("forceR", "R给最佳目标", true).SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
            ...
            var spellMenu = new Menu("技能", "SpellMenu");
            {
                ...
                {
                    wMenu.AddItem(new MenuItem("W_Only_Orb", "只用球",true).SetValue(false));
            ...
            {
                miscMenu.AddItem(new MenuItem("QE_Interrupt", "QE打断技能",true).SetValue(true));
                miscMenu.AddItem(new MenuItem("E_Gap_Closer", "使用E防突进",true).SetValue(true));
                miscMenu.AddItem(new MenuItem("smartKS", "使用智能击杀系统", true).SetValue(true));
            ...
            var drawMenu = new Menu("显示", "Drawing");
            {
                ...
                drawMenu.AddItem(new MenuItem("Draw_QE_Line", "显示QE线",true).SetValue(true));
